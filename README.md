...
- Abrir terminal de comandos
  - git clone https://github.com/ElliotXLeo/pokemons-inc-mern-frontend.git
  - cd pokemons-inc-mern-frontend
  - Crear en "/" el archivo .env.local en base al .env.template
  - npm install
  - npm start
